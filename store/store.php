...
$lock_pdo = new PDO($ini_conf['lock']['pdo-string'], $ini_conf['lock']['user'], $ini_conf['lock']['password']);
...
$pdo_db = new PDO($ini_conf['storage']['pdo-string'], $ini_conf['storage']['user'], $ini_conf['storage']['password']);
